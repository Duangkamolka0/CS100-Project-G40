const config = {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    // Function to insert an image into a specified element
    function insertImage(imageUrl, targetElementId) {
    ...
    // Call the insertImage function with the image URL and the target element ID
    insertImage('https://example.com/your-image.jpg', 'imageContainer');
    ...
    // Additional event listeners or functions can be added here if needed
